...
const TutorsPage = () => {
  ...
  return (
    <div className="relative w-full font-gilroy overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row bg-[#136FB6] items-center justify-around">
        {/* Left section (Text on top on small screens) */}
        <div className="order-2 md:order-1 md:text-left text-center  text-white sm:max-w-[80%] md:max-w-[600px] py-12 md:py-0 px-4 sm:px-8">
          ...
          <p className="text-white text-[12px] sm:text-[14px] md:text-[16px] text lg:text-[20px] mt-4 md:mt-8">
      ...
      <div className="max-w-full  mx-12  rounded-lg left-4 right-4 bg-[#0F283C] p-4 sm:p-7  ">
      ...
      >
        <SigninModal isOpen={LoginModelOpen} closeLoginModal={closeLoginModal} defaultRole={defaultRole} />
      </ReactModal>
    </div>
  );
};
