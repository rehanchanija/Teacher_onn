...
const OnlineStore = () => {
  return (
    <div className="bg-[#146DB2] mx-6 md:mx-14 md:mt-24 mt-20 rounded-2xl">
      <div className="md:flex justify-between max-w-6xl mx-auto lg:space-x-12 xl:space-x-24 md:px-4 space-x-4 space-y-3 ">
        ...
        <div className=" text-white md:w-[50%] pt-6 md:pb-12 pb-8 ">
          <h1 className="text-[30px] xl:text-[50px] pb-4  font-bold  ">Online Store</h1>
          ...
          <p className="pb-6 md:font-semibold font-medium text-[16px] xl:text-[26px]">
