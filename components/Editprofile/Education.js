            ...
            <div className="w-full bg-white">
                <div className="relative max-w-[1281px] mx-auto shadow-lg -mt-8">
                    <div className="w-full bg-white">
                        <div className="relative max-w-[1281px] mx-auto shadow-lg -mt-8">
                            <div
                                className="relative text-black w-full max-w-[1281px] min-h-[117px] h-auto mt-[-2rem] rounded-tl-lg rounded-tr-lg flex justify-between items-center py-4 md:py-6 px-4 pl-10"
                                style={{ top: "-10%" }}
                            >
                                <button
                                ...
                                <div className="p-8 bg-[#F2F6FB]">
                                    ...
                                    <div className="mt-8">
                                        ...
                                        <div className="flex  space-x-5 mt-6">
                                            ...
                                            <button
                                                onClick={handleSave}
                                                className="bg-[#0F283C] text-white py-2 px-12 rounded-md font-bold"
                                            >
                                                Save &gt;&gt;
                                            </button>
                                        </div>
